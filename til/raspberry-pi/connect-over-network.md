...
- Start up the Remote Desktop app on Windows.  Input the IP address as above.  XWindows will display where there user/pass (pi/raspberry) will need to be input.  
